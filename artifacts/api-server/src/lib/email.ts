...
const FROM_EMAIL = process.env["FROM_EMAIL"] || "NexBank <noreply@nexbank.app>";
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;">
        <h2 style="color:#1a56db;">Welcome to NexBank, ${name}!</h2>
        ...
        <p style="color:#9ca3af;font-size:12px;">NexBank &mdash; Secure Digital Banking</p>
      </div>
    `,
  });
}
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;">
        ...
        <p>Welcome to NexBank. Your account has been created successfully.</p>
        <div style="background:#f9fafb;border-radius:8px;padding:24px;margin:16px 0;">
